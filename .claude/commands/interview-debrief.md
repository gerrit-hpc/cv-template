...
- `company-notes.md` — if missing, warn that the sync step will have nothing to update and offer to run `/research-company` first. If the user declines, proceed: the debrief file is still written; the sync step is skipped with a note.
