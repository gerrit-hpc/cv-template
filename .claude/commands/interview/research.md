...
- If the folder does not exist: stop. Tell the user `/cv:tailor <jd>` must run first to create the application folder. Do not create a stub folder.
...
- **Don't create stub folders.** This command is downstream of `/cv:tailor` by design.
